**Flow:** Extracted and applied shared  (0.2) and  (2.5) constants to work tasks (mining, chopping) to standardize the critical hit system across the game. Work tasks now crit more often but with more balanced, satisfying multipliers, keeping the feedback loop consistent and fun.
