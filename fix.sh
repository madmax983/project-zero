echo '#[path = "integration/pheromone_gardening_bridge.rs"]' >> tests/integration.rs
echo 'mod pheromone_gardening_bridge;' >> tests/integration.rs

cat << 'INNER_EOF' > tests/integration/pheromone_gardening_bridge.rs
#[cfg(test)]
mod tests {
...
cat << 'INNER_EOF' >> src/layer1/core/integration.rs
