...
## Hyper-Specialized Evolution Chaining

- MUTATION_MANIFESTS → enables → EFFICIENCY_BOOST
- MUTATION_MANIFESTS → enables → SOCIAL_ISOLATION
- MUTATION_MANIFESTS → increases_chance → CLIQUE_FORMATION
- ADAPTATION_SICKNESS_ONSET → enables → WORK_STOPPAGE
- ADAPTATION_SICKNESS_ONSET → enables → MEDICAL_EMERGENCY
- ADAPTATION_SICKNESS_ONSET → increases_chance → FRUSTRATION

## Shipbreaking Chaining

- HULL_BREACHED_MINING → enables → RESOURCE_GAIN
- HULL_BREACHED_MINING → enables → TECH_SALVAGE
- HULL_BREACHED_MINING → increases_chance → ACCIDENT_RISK
- HULL_ROOM_BUILT → enables → UNIQUE_ARCHITECTURE
- HULL_ROOM_BUILT → increases_chance → MORALE

## Neural Leech Chaining

- NEURAL_HUB_CONNECTED → enables → NEURAL_LINK_ACTIVE
- NEURAL_HUB_CONNECTED → enables → HUB_DEATH_SHOCK
- NEURAL_HUB_CONNECTED → increases_chance → GUILT
- NEURAL_LINK_ACTIVE → enables → PRODUCTIVITY_BOOST
- NEURAL_LINK_ACTIVE → enables → TECH_BREAKTHROUGH
- NEURAL_LINK_ACTIVE → increases_chance → EFFICIENCY
- HUB_DEATH_SHOCK → enables → MASS_BREAKDOWN
- HUB_DEATH_SHOCK → enables → MEDICAL_EMERGENCY
- HUB_DEATH_SHOCK → increases_chance → STRESS

## Light Pollution Chaining

- SKY_GLOW_WARNING → enables → OBSERVATORY_BLINDED
- SKY_GLOW_WARNING → enables → NOCTURNAL_ATTACK
- SKY_GLOW_WARNING → increases_chance → FEAR_OF_TECH
- OBSERVATORY_BLINDED → enables → RESEARCH_STALL
- OBSERVATORY_BLINDED → increases_chance → FRUSTRATION

## The Spiteful Will Chaining

- SPITEFUL_WILL_READ → enables → WILL_OVERRIDDEN
- SPITEFUL_WILL_READ → enables → RIVALRY_STARTED
- SPITEFUL_WILL_READ → increases_chance → UNREST
- WILL_OVERRIDDEN → enables → PROTEST
- WILL_OVERRIDDEN → enables → BRAWL
- WILL_OVERRIDDEN → increases_chance → RESENTMENT
