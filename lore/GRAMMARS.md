...
- KINETIC_EXCAVATION_SUCCESS -> increases_chance -> WEALTH_BOOM, RESOURCE_CURSE, ECOLOGICAL_DECAY
- KINETIC_EXCAVATION_MAGMA -> enables -> COLONY_FIRE, CASUALTIES, EVACUATION
- KINETIC_EXCAVATION_MAGMA -> increases_chance -> PUBLIC_GRIEVANCE, UNREST
