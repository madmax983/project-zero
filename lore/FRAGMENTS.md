...
*Building blocks for procedural text. Tagged by type for the generator.*
...
scattered to the dark
burned in civil war
transcended (unclear how)
fell to the Wound
merged with [OTHER_CIV]
devoured by their own creations
sleep now (disputed)
became something else
are still here (hiding)
left only ruins
chose oblivion
were unmade
forgot themselves
...
```
charted the Wound's edge
built the [ARTIFACT]
seeded a hundred worlds
held the Long Peace
spoke to [UNKNOWN]
mapped foldspace
...
scientist
captain
farmer (when it mattered)
child (when it mattered)
leader
builder
destroyer
rememberer
...
dangerous
inert
singing (emits signal)
warm (inexplicably)
cold (inexplicably)
changing
stable
unstable
fake (discovered later)
real (disputed)
```
...
forged during [WAR]
last work of [PERSON]
first creation of [CIV]
salvaged from [PLACE]
gift from [CIV] to [CIV]
stolen (by whom: disputed)
found in the Wound
emerged from foldspace
always been here (claimed)
built in secret
built in desperation
commissioned by [PERSON]
accident
```
...
Who the spiteful pop left their belongings to.

- the colony pet
- a total stranger
- their worst enemy (as a joke)
- the structural integrity fund
- no one (to be burned)
- the lowest ranking laborer
- a broken drone

## Fragment Type: [WILL_CONDITION]
The ridiculous condition for inheriting the stash.

- on the condition they never speak of me
- to spite their own lineage
- if they wear my boots for a year
- so they can fail where I succeeded
- because I know they will waste it
- to guarantee my rival gets nothing
- as a final insult

## Fragment Type: [WILL_REACTION]
How the colony reacts to the will.

- outrage in the mess hall
- bitter laughter
- a silent feud begins
...
## Debt Collector Fragments (Spec 436)

## Fragment Type: [BLOCKADE_NAME]
- The Collection Sphere
- The Iron Ring
- The Creditor's Net
- The Debt Fleet
- The Gold-Plated Noose
- The Repo-Swarm
- The Ledger's Arm

## Fragment Type: [CREDITOR_TITLE]
- The Core Banks
- The Interest Keepers
- The Old Lenders
- The Guild of Coin
- The Iron Ledger
- The Debt-Brokers
