...
pub fn setup_world_with_config(#[allow(unused_variables)] config: SetupConfig) -> World {
    ...
    world.init_resource::<crate::layer1::civic_ideology::CivicIdeology>();
    ...
    world.insert_resource(crate::layer1::social::empty_room::SanctuaryManager::default());
    ...
    world.insert_resource(crate::layer1::social::bureaucratic_strike::RedTapeEvent { active: false, severity: 1 });
