...
pub fn setup_world_with_config(#[allow(unused_variables)] config: SetupConfig) -> World {
    ...
    world.init_resource::<Events<crate::layer1::sub_surface_flora::HarvestCropEvent>>();
    world.init_resource::<Events<crate::layer1::sub_surface_flora::LocalizedTremorEvent>>();
