...
use crate::layer1::{
    ...
    apply_lighting_penalties_system, apply_noise_effects_system, apply_palette_fatigue_system,
    ...
    assign_sleepwalk_target_system, biocompatibility_system, check_heirloom_status_system,
    check_milestones_system, check_sleepwalking_start_system, check_spontaneous_build_system,
    ...
    demolish_personal_structure_system, discovery_system, entropy_system,
...
pub fn build_simulation_schedule() -> Schedule {
    ...
    schedule.add_systems((
        ...
        demolish_personal_structure_system.after(work_execution_system),
