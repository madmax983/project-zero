...
fn register_simulation_extended_systems(schedule: &mut Schedule) {
    ...
    schedule.add_systems((
        ...
        crate::layer3::isolation::track_colony_isolation_system,
        crate::layer3::isolation::process_isolation_needs_system
            .after(crate::layer3::isolation::track_colony_isolation_system),
        crate::layer3::isolation::spawn_silence_cult_system
            .after(crate::layer3::isolation::process_isolation_needs_system),
