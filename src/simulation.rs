...
pub fn run_simulation_tick(world: &mut World) {
    ...
    if !world
        .contains_resource::<crate::layer3::diplomacy::cultural_pressure::CulturalInfluenceGrid>()
    {
        world
            .init_resource::<Events<crate::layer3::diplomacy::cultural_pressure::DefectionEvent>>();
