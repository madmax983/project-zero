...
pub const GRAVITY_DEBT_MULTIPLIER: f32 = 0.0001;

// The spec requires this struct, ignoring potential conflicts for this task scope.
...
impl GravityDebt {
    pub fn current_gravity_modifier(&self) -> f32 {
        ...
        1.0 + (net_mass * GRAVITY_DEBT_MULTIPLIER).max(0.0)
    }
}
