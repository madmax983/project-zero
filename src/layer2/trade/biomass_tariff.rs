...
mod tests {
    ...
    use super::{TradeDeal, process_biomass_tariff_system};
    use crate::layer1::resources::ColonyResources;
    use crate::layer1::pop::Pop;
    use crate::layer1::stress::StressTracker;
    ...
    fn test_pay_biomass_tariff_with_pops_damages_sanity() {
        ...
        let pop_to_trade = world.spawn((Pop, StressTracker { accumulated_stress: 10.0 })).id();
        ...
        let bystander = world.spawn((Pop, StressTracker { accumulated_stress: 10.0 })).id();
        world.send_event(TradeDeal {
            offered_crops: 0.0,
            offered_pops: 0,
            requested_resin: 0.0,
        ...
        assert!(bystander_stress.accumulated_stress <= 10.0, "Stress should be maintained in second run");
