...
pub fn binary_star_system(binary: Res<BinaryStarSystem>, mut solar: Query<&mut SolarPanel>) {
...
pub fn binary_star_crop_system(binary: Res<BinaryStarSystem>, mut crops: Query<&mut Crop>) {
