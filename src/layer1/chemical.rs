...
mod tests {
    ...
    fn test_consume_stim_adds_effect() {
        ...
        let state = world.get::<ChemicalState>(pop).expect("Component should exist or System should run");
        assert!(state
            .active_effects
            .iter()
    ...
    fn test_addiction_buildup() {
        ...
        assert!(addiction.expect("Component should exist or System should run").severity > 0.0);
    }
    ...
    fn test_evaluate_consume_chemical_withdrawal() {
        ...
        let (score, _) = result.expect("Component should exist or System should run");
