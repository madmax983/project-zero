...
//!
//! This module implements the "View" mechanic, where [`crate::layer1::window::Window`]s capture beauty from the environment
...
//! 2.  **Raycasting**: The [`crate::layer1::window::update_window_views_system`] casts a ray from the window in its facing direction.
