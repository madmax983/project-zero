...
mod tests {
    ...
    use crate::layer1::memetics::{
        parasitic_broadcast_risk_system, process_parasitic_work_reduction, MemeticCarrier,
    };
    ...
    fn test_parasitic_broadcast_increases_morale_and_reduces_work() {
        ...
        let pop = world
            .spawn((
                ...
                MemeticCarrier, // Humming the catchy tune
                Skills::default(),
            ))
            .id();
        ...
        world.entity_mut(pop).remove::<MemeticCarrier>();
