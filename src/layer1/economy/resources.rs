...
impl ColonyResources {
    ...
    #[must_use]
    pub const fn with_food(mut self, amount: f32) -> Self {
        self.food = amount;
        self
    }
    ...
    #[must_use]
    pub const fn with_planks(mut self, amount: f32) -> Self {
        self.planks = amount;
        self
    }

    #[must_use]
    pub const fn with_blocks(mut self, amount: f32) -> Self {
        self.blocks = amount;
        self
    }

    #[must_use]
    pub const fn with_ore(mut self, amount: f32) -> Self {
        self.ore = amount;
        self
    }
    ...
    #[must_use]
    pub const fn with_knowledge(mut self, amount: f32) -> Self {
        self.knowledge = amount;
        self
    }

    #[must_use]
    pub const fn with_fiber(mut self, amount: f32) -> Self {
        self.fiber = amount;
        self
    }

    #[must_use]
    pub const fn with_cloth(mut self, amount: f32) -> Self {
        self.cloth = amount;
        self
    }

    #[must_use]
    pub const fn with_clothing(mut self, amount: f32) -> Self {
        self.clothing = amount;
        self
    }

    #[must_use]
    pub const fn with_waste(mut self, amount: f32) -> Self {
        self.waste = amount;
        self
    }

    #[must_use]
    pub const fn with_rations(mut self, amount: f32) -> Self {
        self.rations = amount;
        self
    }

    #[must_use]
    pub const fn with_fuel(mut self, amount: f32) -> Self {
        self.fuel = amount;
        self
    }

    #[must_use]
    pub const fn with_water(mut self, amount: f32) -> Self {
        self.water = amount;
        self
    }

    #[must_use]
    pub const fn with_alcohol(mut self, amount: f32) -> Self {
        self.alcohol = amount;
        self
    }

    #[must_use]
    pub const fn with_scrap(mut self, amount: f32) -> Self {
        self.scrap = amount;
        self
    }

    #[must_use]
    pub const fn with_building_permits(mut self, amount: f32) -> Self {
        self.building_permits = amount;
        self
    }

    #[must_use]
    pub const fn with_credits(mut self, amount: f32) -> Self {
        self.credits = amount;
        self
    }

    #[must_use]
    pub const fn with_max_food(mut self, amount: f32) -> Self {
        self.max_food = amount;
        self
    }
    ...
    #[must_use]
    pub const fn with_max_stone(mut self, amount: f32) -> Self {
        self.max_stone = amount;
        self
    }

    #[must_use]
    pub const fn with_max_planks(mut self, amount: f32) -> Self {
        self.max_planks = amount;
        self
    }

    #[must_use]
    pub const fn with_max_blocks(mut self, amount: f32) -> Self {
        self.max_blocks = amount;
        self
    }

    #[must_use]
    pub const fn with_max_ore(mut self, amount: f32) -> Self {
        self.max_ore = amount;
        self
    }

    #[must_use]
    pub const fn with_max_metal(mut self, amount: f32) -> Self {
        self.max_metal = amount;
        self
    }

    #[must_use]
    pub const fn with_max_tools(mut self, amount: f32) -> Self {
        self.max_tools = amount;
        self
    }

    #[must_use]
    pub const fn with_max_knowledge(mut self, amount: f32) -> Self {
        self.max_knowledge = amount;
        self
    }

    #[must_use]
    pub const fn with_max_fiber(mut self, amount: f32) -> Self {
        self.max_fiber = amount;
        self
    }

    #[must_use]
    pub const fn with_max_cloth(mut self, amount: f32) -> Self {
        self.max_cloth = amount;
        self
    }

    #[must_use]
    pub const fn with_max_clothing(mut self, amount: f32) -> Self {
        self.max_clothing = amount;
        self
    }

    #[must_use]
    pub const fn with_max_waste(mut self, amount: f32) -> Self {
        self.max_waste = amount;
        self
    }

    #[must_use]
    pub const fn with_max_rations(mut self, amount: f32) -> Self {
        self.max_rations = amount;
        self
    }

    #[must_use]
    pub const fn with_max_fuel(mut self, amount: f32) -> Self {
        self.max_fuel = amount;
        self
    }

    #[must_use]
    pub const fn with_max_water(mut self, amount: f32) -> Self {
        self.max_water = amount;
        self
    }

    #[must_use]
    pub const fn with_max_alcohol(mut self, amount: f32) -> Self {
        self.max_alcohol = amount;
        self
    }

    #[must_use]
    pub const fn with_max_scrap(mut self, amount: f32) -> Self {
        self.max_scrap = amount;
        self
    }

    #[must_use]
    pub const fn with_max_building_permits(mut self, amount: f32) -> Self {
        self.max_building_permits = amount;
        self
    }

    #[must_use]
    pub const fn with_max_credits(mut self, amount: f32) -> Self {
        self.max_credits = amount;
        self
    }

    #[must_use]
    pub const fn with_memory_cores(mut self, amount: f32) -> Self {
        self.memory_cores = amount;
        self
    }

    #[must_use]
    pub const fn with_max_memory_cores(mut self, amount: f32) -> Self {
        self.max_memory_cores = amount;
        self
    }

    #[must_use]
    pub const fn with_void_ale(mut self, amount: f32) -> Self {
        self.void_ale = amount;
        self
    }

    #[must_use]
    pub const fn with_max_void_ale(mut self, amount: f32) -> Self {
        self.max_void_ale = amount;
        self
    }
