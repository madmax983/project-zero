        ...
        BuildingType::Smokehouse => {
            entity.insert((
                ...
                LightSource {
                    ...
                    intensity: 0.5,
                    color: (200, 200, 200),
                    is_outdoor: false, // Smoky white/grey
                },
                ShiftSchedule::default(),
            ));
        }
        BuildingType::LumberMill => {
            entity.insert((
                ...
                LightSource {
                    ...
                    intensity: 0.5,
                    color: (200, 180, 100),
                    is_outdoor: false, // Dim Wood light
                },
                SeismicSource {
                    intensity: 0.5,
                    radius: 3.0,
        ...
        BuildingType::Refinery => {
            entity.insert((
                ...
                LightSource {
                    ...
                    intensity: 0.8,
                    color: (100, 200, 255),
                    is_outdoor: false, // Chemical blue
                },
                SeismicSource {
                    intensity: 0.8,
                    radius: 6.0,
        ...
        BuildingType::Library => {
            entity.insert((
                ...
                LightSource {
                    ...
                    intensity: 0.6,
                    color: (240, 240, 255),
                    is_outdoor: false, // White/Blueish
                },
                ShiftSchedule::default(),
            ));
        }
        ...
        BuildingType::AICore => {
            entity.insert((
                ...
                LightSource {
                    ...
                    intensity: 0.8,
                    color: (255, 0, 255),
                    is_outdoor: false, // Magenta/Purple
                },
            ));
        }
        BuildingType::DroneHub => {
        ...
        BuildingType::CloneVat => {
            entity.insert((
                ...
                LightSource {
                    ...
                    intensity: 0.6,
                    color: (0, 255, 100),
                    is_outdoor: false, // Greenish bio-light
                },
                ShiftSchedule::default(),
            ));
        }
        ...
        BuildingType::HoloProjector => {
            entity.insert((
                ...
                LightSource {
                    ...
                    intensity: 0.8,
                    color: (200, 200, 255),
                    is_outdoor: false, // Holographic Blue
                },
