...
pub fn spawn_building_with_material(
    ...
    crate::layer1::building::configuration::spawn_building(world, x, y, building_type, material);
}
...
pub fn try_place_building(world: &mut World, x: i32, y: i32, building_type: BuildingType) -> bool {
    ...
    // Spawn building
    let entity = crate::layer1::building::configuration::spawn_building(
        world,
        x,
        y,
        building_type,
...
mod tests {
    ...
    fn test_place_farm_adds_farm_component() {
        ...
        let farm_count = world
            .query::<&crate::layer1::farm::Farm>()
            .iter(&world)
            .count();
    ...
    fn test_place_housing_adds_housing_component() {
        ...
        let housing_count = world
            .query::<&crate::layer1::housing::Housing>()
            .iter(&world)
            .count();
    ...
    fn test_place_stockpile_adds_stockpile_component() {
        ...
        let stockpile_count = world
            .query::<&crate::layer1::stockpile::Stockpile>()
            .iter(&world)
            .count();
