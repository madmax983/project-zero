...
use crate::layer1::tech::{DataStorage, Library, TechState};
...
pub fn validate_building_placement(world: &World, x: i32, y: i32) -> Result<(), PlacementError> {
...
pub fn handle_placement_error(world: &mut World, error: PlacementError) {
...
pub fn configure_housing(entity: &mut EntityWorldMut, building_type: BuildingType) {
    match building_type {
...
pub fn configure_production(entity: &mut EntityWorldMut, building_type: BuildingType) {
    match building_type {
...
pub fn configure_storage(entity: &mut EntityWorldMut, building_type: BuildingType) {
    match building_type {
...
pub fn configure_civic(entity: &mut EntityWorldMut, building_type: BuildingType) {
    match building_type {
        BuildingType::Tavern => {
            entity.insert((
                Tavern::default(),
...
pub fn configure_infrastructure(entity: &mut EntityWorldMut, building_type: BuildingType) {
    match building_type {
        BuildingType::Window => {
            entity.insert((
...
#[allow(clippy::too_many_lines)]
pub fn configure_power(entity: &mut EntityWorldMut, building_type: BuildingType) {
    match building_type {
        BuildingType::Generator => {
            entity.insert((
                PowerSource {
...
#[allow(clippy::too_many_lines)]
pub fn configure_tech(entity: &mut EntityWorldMut, building_type: BuildingType) {
    match building_type {
        BuildingType::Observatory => {
            entity.insert((
