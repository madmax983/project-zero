...
pub fn adjust_sympathetic_infrastructure_system(
    mut building_query: Query<
        (Entity, &mut HeatSource, Option<&Housing>),
        (With<Building>, With<Biomimetic>),
    >,
...
mod tests {
    ...
    fn test_sympathetic_temperature_drop_low_morale_localized() {
        ...
        assert!(
            temp.output < 20.0,
            "Expected heat output to drop due to localized low morale"
        );
        ...
        assert_eq!(
            ...
            1,
            "Should emit BiomimeticShiftEvent"
        );
    }
    ...
    fn test_sympathetic_temperature_rise_high_morale_job_localized() {
        ...
        let building_entity = app
            ...
            .spawn((
                Building {
                    building_type: crate::layer1::architecture::BuildingType::Farm,
                },
                Biomimetic,
                HeatSource { output: 20.0 },
            ))
        ...
        assert!(
            temp.output > 20.0,
            "Expected heat output to rise due to localized high morale"
        );
    ...
    fn test_sympathetic_temperature_clamp() {
        ...
        assert_eq!(
            temp.output, 0.0,
            "Expected heat output to be clamped at 0.0"
        );
    }
}
