...
mod tests {
    ...
    fn test_sleepwalking_trigger() {
        ...
        world.run_system_once(crate::layer1::sleepwalking::check_sleepwalking_start_system).unwrap();
    ...
    fn test_sleepwalking_movement() {
        ...
        world.run_system_once(crate::layer1::sleepwalking::assign_sleepwalk_target_system).unwrap();
    ...
    fn test_sleepwalking_recovery() {
        ...
        // Run recovery system
        world.run_system_once(crate::layer1::sleepwalking::sleepwalk_end_system).unwrap();
