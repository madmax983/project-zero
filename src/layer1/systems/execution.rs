...
pub fn register(schedule: &mut Schedule) {
    ...
    schedule.add_systems(
        (
            ...
            crate::layer1::drone::drone_spawner_bridge_system.after(process_start_plan_system),
            crate::layer1::drone::drone_work_bridge_system.after(process_start_plan_system),
    ...
    schedule.add_systems(
        (
            ...
            crate::layer1::execution::mining::harmonic_mining_system.after(arrival_handler_system),
        )
            .in_set(Layer1SystemSet::Execution),
    );
