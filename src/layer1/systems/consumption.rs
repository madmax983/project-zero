...
pub fn register(schedule: &mut Schedule) {
    ...
    schedule.add_systems(
        (
            ...
            crate::layer1::core::integration::edible_architecture_chronicle_bridge.after(consume_food_system),
            crate::layer1::architecture::edible::consume_building_system.after(crate::layer1::core::integration::edible_architecture_chronicle_bridge)),
