...
pub fn register(schedule: &mut Schedule) {
    schedule.add_systems((crate::layer1::shadow_market::despawn_in_light_system, crate::layer1::shadow_market::spawn_shadow_trader_system,).in_set(Layer1SystemSet::Environment));
