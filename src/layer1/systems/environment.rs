...
pub fn register(schedule: &mut Schedule) {
    ...
    schedule.add_systems(
        (
            ...
            crate::layer1::symbiotic_infrastructure::process_symbiotic_regeneration_system.after(crate::layer1::symbiotic_infrastructure::process_symbiotic_needs_system),
            crate::layer1::symbiotic_infrastructure::process_symbiotic_consumption_system.after(crate::layer1::symbiotic_infrastructure::process_symbiotic_needs_system),
        )
            .in_set(Layer1SystemSet::Environment),
    );
    schedule.add_systems(
