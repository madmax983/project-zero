...
mod tests {
    ...
    use crate::layer1::flora::{Flora, FloraType, consume_silent_flora_system};
    use crate::layer1::map::GridPosition;
    use crate::layer1::needs::Needs;
    use crate::layer1::pop::Pop;
    use crate::layer1::quirks::{PlanetaryTrait, PlanetaryTraits};
    use crate::layer1::physics::acoustic::{NoiseMap, NoiseSource, update_noise_system};
    use crate::layer1::terrain::{TerrainGrid, TerrainType};
    use crate::layer1::fauna::{Fauna, suppress_fauna_system};
    ...
    fn test_silent_flora_growth_bonus() {
        ...
        assert!(needs.hunger > 0.9, "SilentFlora should provide massive nutrition bonus");
    }
    ...
    fn test_silent_flora_nullifies_sound() {
        ...
        assert!(noise_map.get(5, 5) <= 0.1, "Sound should be nullified near Silent Flora");
    }
    ...
    fn test_silent_flora_no_native_fauna() {
        ...
        assert!(app.world().get::<Fauna>(fauna).is_none(), "Native fauna should be suppressed on a Silent World");
    }
}
