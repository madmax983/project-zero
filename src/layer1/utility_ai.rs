...
//!
//! This module implements a Utility AI system where pops evaluate different actions
//! based on their needs, environmental context, and learned weights.
//!
//! It is flattened from a previous `types` / `math` split to enforce KISS.
