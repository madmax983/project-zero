...
impl Traits {
    ...
    pub fn iter(&self) -> impl Iterator<Item = Trait> {
        ...
        let mask = self.0;
        Trait::iter().filter(move |&t| (mask & (1_u64 << (t as u8))) != 0)
    }
...
mod tests {
    ...
    fn test_job_efficiency_modifiers() {
        let green_thumb = Traits(1_u64 << (Trait::GreenThumb as u8));
        let silver_tongue = Traits(1_u64 << (Trait::SilverTongue as u8));
        let mole_eyes = Traits(1_u64 << (Trait::MoleEyes as u8));
        let hunchback = Traits(1_u64 << (Trait::Hunchback as u8));
        let static_skin = Traits(1_u64 << (Trait::StaticSkin as u8));
    ...
    fn test_work_speed_modifiers() {
        let hard_worker = Traits(1_u64 << (Trait::HardWorker as u8));
        let lazy = Traits(1_u64 << (Trait::Lazy as u8));
        let normal = Traits::default();
    ...
    fn test_hunger_decay_modifiers() {
        let glutton = Traits(1_u64 << (Trait::Glutton as u8));
        let ascetic = Traits(1_u64 << (Trait::Ascetic as u8));
        let normal = Traits::default();
    ...
    fn test_leisure_decay_modifiers() {
        let soulless = Traits(1_u64 << (Trait::Soulless as u8));
        let noble = Traits(1_u64 << (Trait::Noble as u8));
        let synth = Traits(1_u64 << (Trait::Synth as u8));
        let normal = Traits::default();
    ...
    fn test_feral_speed_modifier() {
        let feral = Traits(1_u64 << (Trait::Feral as u8));
        let fast = Traits(1_u64 << (Trait::FastWalker as u8));
        let both = Traits((1_u64 << (Trait::Feral as u8)) | (1_u64 << (Trait::FastWalker as u8)));
    ...
    fn test_night_owl_mood_modifier() {
        let night_owl = Traits(1_u64 << (Trait::NightOwl as u8));
