...
use scale::layer1::{
    ...
    process_work_system, produce_food_system, render_map_layer, restore_rest_in_housing_system,
    spawn_initial_pops, update_resource_caps_system,
};
