...
//!
//! This module simulates the falsification of colony reports by corrupt planetary governors.
//! It tracks the divergence between reality (`ColonyState`) and the `ColonyReport` sent to the empire,
//! which can be audited and corrected by the deployment of an `Inquisitor`.
...
/// A report generated by a governor, sent to the empire.
///
/// # Examples
///
/// ```rust
/// use scale::layer3::bureaucracy_of_truth::*;
...
///     ColonyState { food_reserves: 10, unrest: 80.0 },
///     Governor { pop_entity, assigned_at: 0 },
/// )).id();
///
...
/// assert!(report.reported_food > 100); // Falsified!
/// ```
#[derive(Component)]
