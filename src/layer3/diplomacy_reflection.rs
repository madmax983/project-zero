...
mod tests {
    ...
    fn test_aggregate_colony_stats_ignores_invalid_entities() {
        ...
        app.world_mut().send_event(EntityKilledEvent {
            colony_entity: invalid_entity,
        });
        app.world_mut().send_event(FloraPlantedEvent {
            colony_entity: invalid_entity,
        });
    ...
    fn test_apply_diplomatic_reactions_ignores_self_and_non_pacifist() {
        ...
        let non_pacifist_neighbor = app
            .world_mut()
            .spawn((
                Civilization {
                    id: "neighbor1".to_string(),
                },
                DiplomaticTraits {
                    is_pacifist: false,
                    ..default()
        ...
        let neighbor_relations = app
            .world()
            .get::<DiplomaticRelations>(non_pacifist_neighbor)
            .unwrap();
    ...
    fn test_apply_diplomatic_reactions_ignores_other_relations() {
        ...
        let neighbor_relations = app
            .world()
            .get::<DiplomaticRelations>(pacifist_neighbor)
            .unwrap();
        assert!(!neighbor_relations.relations[0].sanctioned);
...
/// Unity currencyy gained through diplomatic and religious actions.
