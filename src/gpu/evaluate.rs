...
mod tests {
    ...
    fn test_action_type_from_u32_roundtrip() {
        ...
        assert_eq!(action_type_from_u32(5), ActionType::Research);
        assert_eq!(action_type_from_u32(6), ActionType::Haul);
        assert_eq!(action_type_from_u32(7), ActionType::Idle);
