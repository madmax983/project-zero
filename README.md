...
> If the `nova` feature is not enabled, dummy structs will be used. Your code will compile but will generate deprecation warnings, and runtime functions will print warnings to the console without doing anything.
>
> *If you see deprecation warnings for `OralTradition`, you forgot to enable the feature!*
