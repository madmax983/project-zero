...
#[path = "integration/deep_crust_resonance_bridge.rs"]
...
#[path = "integration/memorial_revolt_bridge.rs"]
mod memorial_revolt_bridge;

#[path = "integration/founder_effect_bridge.rs"]
mod founder_effect_bridge;

#[path = "integration/clutter_bridge.rs"]
mod clutter_bridge;
...
#[path = "integration/institutional_memory_bridge.rs"]
mod institutional_memory_bridge;
#[path = "integration/living_archive_bridge.rs"]
mod living_archive_bridge;
#[path = "integration/lottery_chronicle_bridge.rs"]
mod lottery_chronicle_bridge;
...
#[path = "integration/feral_admin_chronicle.rs"]
...
#[path = "integration/debt_collector_chronicle_bridge.rs"] mod debt_collector_chronicle_bridge;
