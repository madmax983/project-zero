...
fn test_infected_imports_increase_demand() {
    ...
    app.world_mut().resource_mut::<GalacticMarket>().supply_pool.insert(ResourceType::Food, 1000.0);
    ...
    assert_eq!(*pool, 995.0, "Supply pool should decrease by 5% of imported amount, simulating demand increase");
}
