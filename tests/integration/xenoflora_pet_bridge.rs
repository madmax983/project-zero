...
fn test_pet_system_integration() {
    ...
    app.add_systems(bevy_app::Update, (pet_viral_spread_system, apply_pet_mood_boost).chain());
    ...
    assert!(app.world().get::<XenofloraPet>(pop2).is_some(), "Pop2 should have caught the pet");
