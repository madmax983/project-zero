...
use scale::layer2::orbit::debris_cult::{
    apply_debris_cult_morale_system, evaluate_debris_cult_formation_system, DebrisCultist,
};
...
fn test_debris_cult_bridge() {
    ...
    app.add_systems(
        Update,
        (
            evaluate_debris_cult_formation_system,
            apply_debris_cult_morale_system,
        )
            .chain(),
    );
