use bevy::prelude::*;
use scale::layer2::events_new::system_quarantine::{apply_quarantine_effects, handle_quarantine_decay, SystemQuarantine, TradeHub, SystemLocation, Colony, UnrestLevel, ResourceStockpile, WarlordFaction};

#[test]
fn test_system_quarantine_integration() {
    let mut app = App::new();
    app.add_plugins(MinimalPlugins);
    app.add_systems(Update, (apply_quarantine_effects, handle_quarantine_decay).chain());
