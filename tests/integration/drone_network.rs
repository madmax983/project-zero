...
mod tests {
    ...
    fn setup_world() -> World {
        ...
        world.init_resource::<Events<scale::layer1::whispering_ore::MinedOreEvent>>();
        world.init_resource::<Events<scale::layer1::whispering_ore::MineSealedEvent>>();
        world.init_resource::<scale::layer3::market::GalacticMarket>();
        world.init_resource::<scale::layer3::council::GalacticCouncil>();
        world.init_resource::<scale::layer3::map::MapData>();
        world.init_resource::<Events<scale::layer3::map::FleetArrivalEvent>>();
        world.init_resource::<Events<scale::layer3::map::AnomalyDiscoveredEvent>>();
        ...
        world.init_resource::<Events<scale::layer2::trade::escape_velocity::LaunchShipEvent>>();
        ...
        world.init_resource::<Events<scale::layer1::shipbreaking::SpawnCrashedShipEvent>>();
        world.init_resource::<Events<scale::layer1::shipbreaking::MineEvent>>();
        ...
        world.init_resource::<Events<scale::layer1::nanite_fabrication::ContainmentBreachEvent>>();
        ...
        world.init_resource::<Events<scale::layer1::genetics::GeneSplicingEvent>>();
        world.init_resource::<Events<scale::layer1::genetics::GeneSplicingResultEvent>>();
        world.init_resource::<Events<scale::layer2::governance::RebellionEvent>>();
        world.init_resource::<Events<scale::layer1::disasters::DisasterEvent>>();
        world.init_resource::<Events<scale::layer2::tourism::disaster_tourism::GriefTouristArrivalEvent>>();
        world.init_resource::<Events<scale::layer2::trade::biomass_tariff::TradeDeal>>();
        world.init_resource::<Events<scale::layer2::events_new::reverse_quarantine::RefugeeFleetEvent>>();
        world.init_resource::<Events<scale::layer1::environment::events::DebrisFallEvent>>();
