use bevy::prelude::*;
use scale::layer1::deep_crust_resonance::{ExcavationEvent, ResonantInfection, ResonantOre, MineableOre, resonant_ore_exposure_system, resonance_social_spread_system};
...
fn test_deep_crust_resonance_integration() {
    ...
    assert!(morale_a.modifiers.iter().any(|m| m.label == "Deep Resonance"));
