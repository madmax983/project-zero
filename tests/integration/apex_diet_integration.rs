...
mod tests {
    use bevy::prelude::*;
    use scale::layer1::economy::apex_diet::{ApexMeatStores, ConsumeFoodEvent, process_apex_meat_consumption};
    use scale::layer1::needs::Needs;
    use scale::layer1::pop::Pop;
    use scale::layer1::balance::FOOD_PER_MEAL;
    use scale::layer1::core::integration::{apex_meat_harvest_bridge_system, apex_meat_distribution_system};
    ...
    fn test_hungry_pops_consume_apex_meat() {
        ...
        let pop = app.world_mut().spawn((
            Pop,
            Needs { hunger: 0.1, rest: 1.0, hygiene: 1.0, leisure: 1.0 }, // Very hungry
        ...
        let morale = app.world().get::<scale::layer1::economy::apex_diet::Morale>(pop).unwrap();
        let strength = app.world().get::<scale::layer1::economy::apex_diet::PhysicalStrength>(pop).unwrap();
