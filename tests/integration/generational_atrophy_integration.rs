use bevy::prelude::*;
use scale::layer1::skills::generational_atrophy::{apply_skill_atrophy_system, AutomationLevel, AtrophiedSkill};
...
fn test_generational_atrophy_integration() {
    ...
    app.world_mut().insert_resource(AutomationLevel { level: 80.0 });
    ...
    assert_eq!(*updated_skills.xp.get(&SkillType::Farming).unwrap_or(&0.0), 50.0);
}
