...
use scale::layer1::nanite_fabrication::{Nanoforge, ContainmentBreachEvent, nanite_fabrication_system};
...
fn test_nanoforge_containment_breach_emits_chronicle() {
    ...
    app.add_systems(bevy_app::Update, (
        ...
        nanite_breach_chronicle_bridge
    ).chain());
    ...
    assert_eq!(chronologies.len(), 1, "Should emit a chronicle event on containment breach");
