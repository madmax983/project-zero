use bevy::prelude::*;
use scale::layer1::physics::gravity_plating::{GravityState, MovementType, PowerGridEvent, Zone, GravityGenerator, CurrentZone, TraitList};
...
fn test_gravity_plating_failure_integration() {
    ...
    app.world_mut().get_mut::<PowerConsumer>(generator).unwrap().active = false;
