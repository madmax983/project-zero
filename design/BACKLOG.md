...
- [ ] `005` Pop needs (hunger, rest) — `specs/005-pop-needs.md`
- [ ] `006` Building placement system — `specs/006-building-placement.md`
...
- [ ] `012` Input Architecture and Context Routing — `specs/012-input-architecture.md`
