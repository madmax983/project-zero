...
*Architect:* Withdrawal should incapacitate the Pop (dropping them to 0 efficiency and forcing them into a Medical bed) and apply massive Stress, but not directly kill them.
*Architect: Extreme withdrawal should incapacitate Pops, causing severe mood penalties and halting their work, but should not be directly fatal.*
...
*Architect:* Use the existing "Lab" building for now, adding a new production recipe specifically for these chemicals to save on asset/entity bloat.
*Architect: A dedicated "Chemical Plant" building should be required to manufacture high-tier regulated substances.*
