...
*Architect:* Yes, installing augmentations should use the Medical system, requiring a valid medical bed, a Doctor Pop, and carrying a risk of failure based on the Doctor's skill.
