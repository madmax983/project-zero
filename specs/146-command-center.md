...
-   *Architect:* Yes, if one is destroyed, others maintain the command network.
-   *Builder: Does the Command Center need to be staffed?*
-   *Architect:* Yes, it requires at least one Pop with the Administrator job to function.
