...
*Architect:* Yes, absolutely. Do not rewrite the base grids to 3D. Instead, implement a localized `VerticalExtension` component or a sparse auxiliary grid specifically for the stump tiles to handle the verticality without disrupting the 2D foundation.
