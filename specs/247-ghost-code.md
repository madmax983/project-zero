...
*Architect:* Residue on a specific tile does not stack in intensity, but multiple adjacent tiles with residue will linearly increase the area-of-effect severity.
