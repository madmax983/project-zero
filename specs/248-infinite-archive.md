...
*Architect:* No, deleting a prerequisite frees up the storage but leaves the already-researched advanced tech fully functional. It only prevents researching *new* branches from that deleted node.
